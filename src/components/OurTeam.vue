    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 ">
        <div class="bg-white p-6 rounded-lg shadow-lg bg-gradient-to-b from-[#CCC9CD] to-[#f3f0e9] ">
          ...
          <h2 class="text-center text-gray-700 font-semibold text-lg">Especialista en estética Dental y prostodoncia</h2>
          <p class="text-center text-gray-700"><br>Licenciada en Odontología. Universidad de Carabobo (UC), Venezuela.<br>Máster oficial en prótesis, implantoprótesis y estética dental avanzada. Universidad Europea de Madrid (UEM).<br>Diplomada en operatoria y estética dental mínimamente invasiva. Universidad Central de Venezuela (UCV).<br>Experta en estética labial y perioral. Dra.Carla Barber<br>Miembro de la sociedad española de prótesis estomatológica y estética dental (SEPES).
<br>Miembro de la sociedad venezolana de operatoria dental, estética y biomateriales (SVODEB)</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg bg-gradient-to-b from-[#CCC9CD] to-[#f3f0e9]">
          ...
          <h3 class="text-xl font-bold text-center">Dr. Juan Carlos Gutierrez</h3>
          <h2 class="text-center text-gray-700 font-semibold text-lg">Especialista en Implantes</h2>
          <p class="text-center text-gray-700"><br>Licenciado en Odontología<br>Univ Europea de Madrid 2005-2010
...
Comunicaciones en congresos y publicaciones en revistas de alto impacto.</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg bg-gradient-to-b from-[#CCC9CD] to-[#f3f0e9]">
          ...
          <h2 class="text-center text-gray-700 font-semibold text-lg">Higienista</h2>
