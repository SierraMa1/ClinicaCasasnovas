<template>
  <div class="relative w-full max-w-2xl mx-auto mt-8 ">
    <div class="relative overflow-hidden h-[400px]  text-white ">
      
     
      <img 
        :src="beforeImage" 
        alt="Before Image" 
        class="absolute w-full h-full object-cover transition-transform duration-300 ease-in-out hover:scale-110  hover:opacity-80 rounded-3xl text-white "
      />
      ...
      >
        <div class="absolute top-1/2 left-1/2 w-6 h-6 bg-white rounded-full shadow-lg transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
          <div class="w-4 h-4 bg-[#c9bba5] rounded-full"></div>
        </div>
      </div>
    </div>
  </div>
